...
const BalanceSheetReportSchema = new mongoose.Schema({
  ...
  reportName: { type: String, required: true, default: 'Balance Sheet' },
  periodKey: {
    type: String,
...
BalanceSheetReportSchema.index(
  { company: 1, reportName: 1, periodKey: 1 },
  { unique: true }
);

export default mongoose.model('BalanceSheetReport', BalanceSheetReportSchema);
